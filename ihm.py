...
class Ui_main_ihm(object):
    def setupUi(self, main_ihm):
        ...
        self.spinbox_nb_vehicle.setProperty("value", 10)
        ...
        self.label.setGeometry(QtCore.QRect(190, 710, 47, 21))
